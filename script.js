    ...
    function handleTouchStart(event) {
      ...
      function checkCollision() {
          ...
          if (
              ...
              showPopup(question[currentQuestionIndex].Assessment_Question, question[currentQuestionIndex].optionList);
      ...
      function resetApple(apple) {
          const randomLeft = Math.floor(Math.random() * (windowWidth - apple.offsetWidth));
    ...
    function updateScoreDisplay() {
      ...
      function showCongratulationsPopup() {
          if (currentQuestionIndex === question.length && !isPopupOpen) {
              ...
              congratulationsMessage.textContent = 'Congratulations! You have completed the quiz. Thank you for participating.';
